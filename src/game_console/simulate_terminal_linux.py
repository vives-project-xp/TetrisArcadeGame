...
class FakeConsole:
    ...
    def commit_displays(self) -> None:
        ...
        sys.stdout.write("Controls: A/D left-right, S down, W up, SPACE start, T screensaver, Q quit\n")
        sys.stdout.write("\n")
    ...
    def run(self) -> None:
        ...
        try:
            ...
            print("\x1b[2J\x1b[H", end="") # clear screen on exit
        ...
        if key == "\x1b":  # escape sequence
            if select.select([sys.stdin], [], [], 0.01)[0]:
                ...
                if select.select([sys.stdin], [], [], 0.01)[0]:
                    ...
                    if arrow_key == 'A': key = 'w'
                    elif arrow_key == 'B': key = 's'
                    elif arrow_key == 'C': key = 'd'
                    elif arrow_key == 'D': key = 'a'
